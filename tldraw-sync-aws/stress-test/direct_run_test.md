docker run --rm -i grafana/k6 run -e BASE_URL=wss://aws-sync.example.com -e ROOMS=100 -e USERS_PER_ROOM=70 - << 'EOF'
import ws from 'k6/ws';
import { check } from 'k6';
import { Counter, Trend, Rate } from 'k6/metrics';
const ROOMS = parseInt(**ENV.ROOMS) || 100;
const USERS_PER_ROOM = parseInt(**ENV.USERS_PER_ROOM) || 70;
const BASE_URL = **ENV.BASE_URL || 'wss://aws-sync.example.com';
