...
async function runHandoverTest() {
  ...
  try {
    ...
    log(colors.blue, "TEST", "Step 2: Second user connects (simulates routing to different pod after scale-up)");
    log(colors.blue, "TEST", "If handover works, connection should succeed after brief coordination\n");
