/**
 * Minimal example: hooking a tldraw frontend up to the tldraw-sync-gcp backend.
 *
...
// Where the tldraw-sync-gcp server is running. In production this is your
// GCP load balancer URL (e.g. https://gcp-sync.example.com).
...
// server, which streams it into the GCS bucket, and hand back the URL.
const assetStore: TLAssetStore = {
  async upload(_asset, file) {
    ...
    // other client resolves the same GCS-backed URL.
    return { src: url }
  },
